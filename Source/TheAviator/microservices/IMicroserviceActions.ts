...
export interface IMicroserviceActions {
    ...
    commitEvent(tenantId: Guid, eventSource: Guid, artifactId: Guid, content: any, publicEvent?: boolean): Promise<void>;
    commitPublicEvent(tenantId: Guid, eventSource: Guid, artifactId: Guid, content: any): Promise<void>;
