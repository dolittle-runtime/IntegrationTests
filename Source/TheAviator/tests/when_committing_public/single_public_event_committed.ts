...
export class single_public_event_committed extends scenario_for_two_microservices {
    ...
    then_external_event_handler_should_have_been_handled = () => this.consumer?.stream_processors?.should_have_event_handler_at_position(this.tenant, EventHandlers.publicEventHandlerId, 1);
}
