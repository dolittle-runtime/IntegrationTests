...
import { EventObject } from '@dolittle/aviator';
import { EventHandlers } from '@dolittle/aviator';
import { Gherkin,  } from '@dolittle/aviator';
import { a_single_microservice } from '../given/a_single_microservice';

@Feature('Private events')
export class two_events_with_pause_inbetween_committed extends Gherkin.ScenarioFor<a_single_microservice> {
